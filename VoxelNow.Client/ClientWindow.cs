...
namespace VoxelNow.Client {
    internal class ClientWindow : GameWindow{
        internal ClientWindow() : base(new GameWindowSettings() { UpdateFrequency = 70}, new NativeWindowSettings() { Size = new OpenTK.Mathematics.Vector2i(1920, 1080) , NumberOfSamples = 4} ) { }
        ...
        protected override void OnLoad() {
            ...
            for (int x = 0; x < chunkDatabase.chunks.Length; x++) {
                ...
                solidCunkFabricData.voxelsIDs = chunkDatabase.GetCompleteChunkVoxelsData(x);
